        ...
        case 'projects': {
            ...
            return (
                <div
                    ...
                    className='bg-[var(--color-soft)] p-4 rounded-md shadow-sm text-sm hover:shadow-md'
                >
        ...
        case 'experience': {
            ...
            return (
                <div className="bg-[var(--color-soft)] p-3 rounded-md shadow-sm text-sm hover:shadow-md">
                    ...
                    {description && <p className="text-[var(--color-text-muted)] font-semibold mb-1">{description}</p>}
        ...
        case 'education': {
            ...
            return (
                <div className="bg-[var(--color-soft)] p-3 rounded-md shadow-sm text-sm hover:shadow-md">
                    ...
                    {duration && <p className="text-[var(--color-text-muted)] font-semibold mb-0.5">{duration}</p>}
